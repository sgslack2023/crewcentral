    ...
    >
        ...
        <List
          ...
          renderItem={(definition) => (
            <List.Item
              ...
              style={{
                backgroundColor: selectedDefinition?.id === definition.id ? '#e6f7ff' : 'transparent',
                padding: '12px',
                borderRadius: '6px'
              }}
            >
              <List.Item.Meta
                title={
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
                    {definition.name}
                    <Tag color="purple">{definition.charge_type}</Tag>
      ...
      >
        ...
        <div>
          ...
          <h4 style={{ marginTop: '16px', marginBottom: '12px', color: '#1890ff' }}>
        ...
        <Form.Item style={{ marginBottom: '0', marginTop: '16px' }}>
          <Space style={{ width: '100%' }}>
            <Button htmlType="submit" type="primary" loading={loading}>
              {selectedDefinition ? "Update Definition" : "Add Definition"}
            </Button>
            {selectedDefinition && (
